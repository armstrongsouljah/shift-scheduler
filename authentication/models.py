...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    # phone number of the user require upon registratio
    phone = models.CharField(max_length=200, default='+256774123456')

    address = models.CharField(max_length=250, default='Kampala, Uganda')
